...
- Ajouter les illustrations des cartes mineures restantes (même gabarit que `assets/`, 500×750px, JPEG qualité ~88) — les 22 arcanes majeurs et les 7 premières cartes numérales d'Épées (As à 7) sont désormais illustrés, il reste 49 cartes mineures (8-10 d'Épées, les 4 figures de cour d'Épées, et les 40 cartes des 3 autres enseignes). La double lecture Marseille + mythologie (`CARD_LORE`), elle, couvre déjà les 78 cartes — l'illustration et le texte avancent à des rythmes indépendants.
