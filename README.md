...
- `assets/` — illustrations des 22 arcanes majeurs (Le Mat, Bateleur, Papesse, Impératrice, Empereur, Pape, Amoureux, Chariot, Justice, Hermite, Roue de Fortune, Force, Pendu, Arcane sans nom, Tempérance, Diable, Maison-Dieu, Étoile, Lune, Soleil, Jugement, Monde) — collection complète. Illustration progressive des 56 cartes mineures : le jeu numéral complet d'Épées (As à 10, `card-epees-1.jpg` à `card-epees-10.jpg`) plus deux figures de cour de la même enseigne (Valet et Cavalier, `card-epees-valet.jpg`/`card-epees-cavalier.jpg`) sont désormais illustrés ; le reste des mineures (Reine et Roi d'Épées, les 40 cartes des 3 autres enseignes) utilise encore un glyphe emoji ou des pips en attendant son illustration. 4 illustrations (`learn-*.jpg`) pour les cases de l'onglet Apprendre, et 4 illustrations (`suit-*.jpg`) pour les 4 enseignes dans les sous-sections « Figures de cour » et « Cartes numérales ».
...
- Ajouter les illustrations des cartes mineures restantes (même gabarit que `assets/`, 500×750px, JPEG qualité ~88) — les 22 arcanes majeurs, les 10 cartes numérales d'Épées et 2 de ses 4 figures de cour (Valet, Cavalier) sont désormais illustrés, il reste 44 cartes mineures (Reine et Roi d'Épées, et les 40 cartes des 3 autres enseignes). La double lecture Marseille + mythologie (`CARD_LORE`), elle, couvre déjà les 78 cartes — l'illustration et le texte avancent à des rythmes indépendants.
