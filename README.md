...
- Ajouter les illustrations des cartes mineures restantes (même gabarit que `assets/`, 500×750px, JPEG qualité ~88) — les 22 arcanes majeurs et les 5 premières cartes numérales d'Épées (As à 5) sont désormais illustrés, il reste 51 cartes mineures (6-10 d'Épées, les 4 figures de cour d'Épées, et les 40 cartes des 3 autres enseignes)
