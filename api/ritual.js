...
- Varie le TYPE d'action suggérée d'un jour à l'autre — retour direct d'utilisatrice : la suggestion d'écrire/noter quelque chose (un journal, une liste, une lettre...) revenait presque à chaque fois, quel que soit le jour. Pense aussi à une parole à dire à quelqu'un, une petite décision à prendre, un geste concret, une observation à faire sur soi ou autour de soi, une pause, un contact à reprendre, un renoncement — n'écrire n'est qu'UNE possibilité parmi beaucoup d'autres, à ne proposer que si ça correspond vraiment à la carte ou au thème du jour, jamais par défaut.
