...
const DEITY_LORE = {
  ...
  "héraclès": [
    ...
    "Il obtint ensuite la ceinture d'Hippolyte, reine des Amazones (voir la fiche « Hippolyte »), d'abord prête à la lui offrir de bon cœur — jusqu'à ce qu'Héra, semant la discorde parmi les Amazones, ne transforme la rencontre en bataille. Il ramena seul le troupeau de Géryon depuis les confins du monde connu, cueillit les pommes d'or des Hespérides (voir la fiche « Hespérides ») en soulageant un temps Atlas de son fardeau céleste par la ruse — délivrant au passage Prométhée enchaîné, en abattant d'une flèche l'aigle qui lui dévorait le foie (voir la fiche « Prométhée ») —, et descendit enfin aux Enfers pour en ramener vivant, à mains nues, le chien Cerbère, avant de le rendre à Hadès.",
  ...
  "hécube": [
    ...
    "À la chute de Troie, elle vit ses fils et son mari massacrés, sa fille Cassandre (voir la fiche « Cassandre ») emmenée captive par Agamemnon (voir la fiche « Agamemnon »), et sa fille Polyxène (voir la fiche « Polyxène ») sacrifiée sur le tombeau d'Achille (voir la fiche « Achille ») par Néoptolème (voir la fiche « Néoptolème »), le propre fils de celui qui avait tué son mari. Réduite en esclavage, elle découvrit ensuite le corps de son plus jeune fils, Polydore (voir la fiche « Polydore »), envoyé enfant en Thrace avec un trésor pour le mettre à l'abri : le roi chargé de le protéger, Polymestor (voir la fiche « Polymestor »), l'avait assassiné pour s'emparer de cet or dès la ville tombée.",
  ...
  "otrera": [
    ...
    "Elle devint ainsi, à travers cette seule union, la mère spirituelle de la nation amazone tout entière plutôt que la mère littérale de chacune de ses reines : Antiope et Hippolyte (voir les fiches « Antiope » et « Hippolyte »), qui lui succédèrent, sont ainsi comptées parmi ses héritières sans que les textes anciens ne précisent jamais un lien de sang direct.",
  ...
  "arès": [
    ...
    "Sa figure inspire aussi tout un peuple : les Amazones voient dans leur première reine, Otrera (voir la fiche « Otrera »), une épouse mortelle d'Arès, qui aurait fondé en son honneur le sanctuaire d'Artémis à Éphèse — il devient ainsi, à travers elle, le père spirituel de la nation guerrière tout entière plutôt que le père littéral de chacune de ses reines, Antiope et Hippolyte parmi elles (voir les fiches « Antiope » et « Hippolyte »). Une seule d'entre elles porte pourtant, dans les textes anciens, le titre exact de « fille d'Arès » : Penthésilée, venue prêter main-forte à Troie après la mort d'Hector, tuée en duel par Achille qui, dit-on, pleura en découvrant la beauté de celle qu'il venait d'abattre.",
  ...
  "hippolyte": [
    ...
    "Le second, fils de Thésée et d'Antiope (voir les fiches « Thésée » et « Antiope »), vouait un culte exclusif à Artémis et méprisait ouvertement l'amour et le mariage, provoquant ainsi la colère d'Aphrodite (voir la fiche « Aphrodite »). Pour se venger, elle inspira à sa belle-mère Phèdre (voir la fiche « Phèdre »), seconde épouse de Thésée, une passion irrépressible pour lui ; repoussée et honteuse, Phèdre se donna la mort en laissant une lettre l'accusant faussement de l'avoir agressée.",
