...
const DEITY_NOTES = {
  ...
  "hippolyte":"Nom porté par une reine des Amazones et, sans lien de parenté, par le fils de Thésée voué à Artémis.",
...
const DEITY_LORE = {
  ...
  "apollon": [
    ...
    "Son dernier grand amour resta, lui, sans aucune réciprocité : à la princesse troyenne Cassandre, fille de Priam (voir la fiche « Priam »), il offrit le don de prophétie en échange de ses faveurs — mais elle refusa de tenir sa promesse une fois le don reçu. Ne pouvant le lui reprendre, Apollon la frappa d'une malédiction plus cruelle encore : ses prédictions, toujours exactes, ne seraient plus jamais crues par personne — pas même son avertissement, resté sans écho, contre le cheval de bois conçu par Ulysse (voir la fiche « Ulysse »), qui allait livrer Troie aux Grecs.",
  ...
  "aphrodite": [
    ...
    "Devenue mère, elle ne cessa jamais de veiller sur Énée, jusque sur le champ de bataille de Troie : le voyant blessé par le héros grec Diomède, elle se précipita pour le soustraire aux coups en l'enveloppant de son propre voile. Diomède, encouragé par Athéna à ne pas craindre une déesse étrangère à la guerre, la blessa elle-même au poignet de sa lance, faisant jaillir l'ichor, le sang immortel des dieux, plutôt que du sang mortel. Blessée et en larmes, Aphrodite dut lâcher son fils en plein champ de bataille — ce n'est pas elle qui le confie à quiconque : c'est Apollon qui, de sa propre initiative, le soustrait aussitôt aux Grecs en l'enveloppant d'un nuage, puis l'emporte jusqu'à son propre sanctuaire de Pergame, à Troie, où Léto et Artémis le soignent et le couvrent de gloire, tandis qu'un fantôme à son image se bat à sa place pour tromper les assaillants (voir la fiche « Apollon »). Aphrodite, elle, s'enfuit de son côté se réfugier sur l'Olympe auprès de sa mère Dioné, sous les moqueries d'Héra et d'Athéna : la guerre, lui rappela alors doucement Zeus, n'était pas son domaine.",
  ...
  "hécube": [
    ...
    "À la chute de Troie, elle vit ses fils et son mari massacrés, sa fille Cassandre emmenée captive par Agamemnon, et sa fille Polyxène sacrifiée sur le tombeau d'Achille par Néoptolème, le propre fils de celui qui avait tué son mari (voir la fiche « Achille »). Réduite en esclavage, elle découvrit ensuite le corps de son plus jeune fils, Polydore, envoyé enfant en Thrace avec un trésor pour le mettre à l'abri : le roi chargé de le protéger, Polymestor, l'avait assassiné pour s'emparer de cet or dès la ville tombée.",
  ...
  "priam": [
    "Dernier roi de Troie, Priam régna sur une cité prospère jusqu'à ce que l'enlèvement d'Hélène par son fils Pâris (voir la fiche « Pâris ») n'attire sur elle, dix années durant, le siège des armées grecques. Avec son épouse Hécube (voir la fiche « Hécube »), il eut un très grand nombre d'enfants, parmi lesquels Hector, le plus valeureux (voir la fiche « Hector »), et Cassandre, dont les prophéties, condamnées à n'être jamais crues, annonçaient déjà la ruine de sa cité.",
    ...
    "À la chute de Troie, le vieux roi périt sous les coups de Néoptolème, le propre fils d'Achille, qui le tua au pied même de l'autel de Zeus où il s'était réfugié — une fin que même les Grecs jugèrent après coup comme un sacrilège, tant elle bafouait la protection due à un suppliant.",
  ],
  "hector": [
  ...
  "andromaque": [
    ...
    "Devenue malgré elle la compagne du fils de son ennemi, elle lui donna plusieurs enfants avant qu'il ne l'unisse, à sa mort, à Hélénos, l'un des derniers fils survivants de Priam — une vie entièrement redéfinie par la guerre, de princesse troyenne à captive, puis reine d'un royaume grec lointain.",
  ],
  "pâris": [
    ...
    "Blessé mortellement à son tour par une flèche empoisonnée durant le siège, il implora l'aide de sa première épouse, la nymphe Œnone, qu'il avait abandonnée pour Hélène et qui seule savait le guérir — elle la lui refusa par dépit, puis, prise de remords après sa mort, se donna elle-même la mort à ses côtés.",
  ],
  "hélène": [
    ...
    "Déjà mariée au roi Ménélas de Sparte, elle fut promise par Aphrodite au prince troyen Pâris (voir la fiche « Pâris »), vainqueur du jugement rendu sur le mont Ida pour prix d'une pomme d'or (voir la fiche « Pomme »). Qu'elle l'ait suivi de son plein gré, séduite, ou enlevée contre sa volonté selon les versions, son départ pour Troie donna le prétexte à la guerre qui allait durer dix ans et coûter la vie à toute une génération de héros.",
  ...
  "clytemnestre": [
    "Fille de Léda et du roi Tyndare (voir la fiche « Léda »), sœur d'Hélène (voir la fiche « Hélène »), Clytemnestre épousa Agamemnon, roi de Mycènes, avec qui elle eut plusieurs enfants, dont Iphigénie et Oreste (voir la fiche « Iphigénie »).",
    ...
    "Durant les dix années du siège de Troie, elle prit pour amant Égisthe, cousin d'Agamemnon déjà porteur d'une haine ancienne envers sa famille. À son retour, elle accueillit son époux en épouse fidèle en apparence, avant de le piéger dans un filet au sortir du bain et de le tuer avec Égisthe — vengeance de mère autant que trahison conjugale, selon l'interprétation qu'on en fait.",
    "Elle mourut à son tour des années plus tard, tuée par son propre fils Oreste venu venger son père — un matricide qui déchaîna sur lui la fureur des Érinyes (voir la fiche « Érinyes »), jusqu'à ce qu'un tribunal institué par Athéna vienne, pour la première fois, remplacer leur vengeance sans fin par un jugement.",
  ],
  "persée": [
  ...
  "hippolyte": [
    "Deux figures distinctes de la mythologie grecque portent ce même nom, sans lien de parenté entre elles : une reine des Amazones, et un prince trahi par le destin — seule leur réputation d'intégrité inflexible les rapproche.",
    "La première, reine des Amazones, possédait une ceinture offerte par Arès lui-même en récompense de sa valeur guerrière (voir la fiche « Arès ») ; l'obtenir constitua le neuvième des douze travaux d'Héraclès (voir la fiche « Héraclès »). Prête d'abord à la lui céder de bon cœur, la rencontre tourna à la bataille lorsque Héra, semant la discorde parmi les Amazones, les persuada qu'Héraclès venait en réalité enlever leur reine. Selon certaines traditions, cette même reine — ou sa sœur, les sources hésitant sur ce point — est aussi celle qu'épousa plus tard Thésée sous le nom d'Antiope (voir la fiche « Antiope »).",
    "Le second, fils de Thésée et d'Antiope (voir les fiches « Thésée » et « Antiope »), vouait un culte exclusif à Artémis et méprisait ouvertement l'amour et le mariage, provoquant ainsi la colère d'Aphrodite (voir la fiche « Aphrodite »). Pour se venger, elle inspira à sa belle-mère Phèdre, seconde épouse de Thésée, une passion irrépressible pour lui ; repoussée et honteuse, Phèdre se donna la mort en laissant une lettre l'accusant faussement de l'avoir agressée.",
  ...
  "érichthonios": [
    ...
    "Pour le soustraire aux regards, Athéna l'enferma dans un coffre qu'elle confia à Pandrosos, fille du roi Cécrops, en lui interdisant formellement de l'ouvrir. Curieuses, les deux sœurs de Pandrosos, Aglauros et Hersé, désobéirent et découvrirent l'enfant enlacé par un serpent — un spectacle si terrifiant que, selon les versions, le serpent les tua sur place, ou que la fureur d'Athéna elle-même les rendit folles au point de se jeter du haut de l'Acropole.",
  ...
  "alcippé": [
    "Fille d'Arès et d'Aglauros, princesse d'Athènes — la même qui, plus tard, ouvrit par curiosité le coffre où Athéna cachait le jeune Érichthonios (voir la fiche « Érichthonios ») —, Alcippé grandit à la cour de son grand-père, le roi Cécrops.",
    "Halirrhothios, fils de Poséidon, tenta de la violenter ; surpris par Arès (voir la fiche « Arès »), qui le tua sur-le-champ pour la défendre, le dieu de la guerre se retrouva alors accusé de meurtre par Poséidon lui-même.",
