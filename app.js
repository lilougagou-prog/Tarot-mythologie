...
"VII — Le Chariot": {
  ...
  myth:"Apollon, dieu de la lumière et de la mesure — non le conducteur du char solaire, rôle qui revient à Hélios seul —, quitte chaque hiver Delphes sur un char tiré par des cygnes pour rejoindre le pays des Hyperboréens, avant d'y revenir au printemps. Sa victoire n'est jamais un coup d'éclat isolé : c'est une discipline répétée qui finit par ressembler à une évidence."
},
"VIII — La Justice": {
...
const SYMBOL_LIBRARY = {
  ...
  "caducée":{icon:"⚕",label:"Caducée",category:"Mythologie",desc:"Attribut d'Hermès : médiation, circulation, communication entre des mondes séparés.",links:["hermès","cadmos","harmonie"],lore:[
    ...
    "Ce même motif de deux serpents unis plutôt qu'ennemis se retrouve, de façon frappante, dans un tout autre mythe : devenus vieux, Cadmos et son épouse Harmonie furent changés ensemble en serpents et menés côte à côte vers les Champs Élysées plutôt que vers une fin funeste (voir la fiche « Harmonie »). Rien ne prouve que les Anciens aient eux-mêmes établi ce rapprochement entre les deux récits, mais certains y voient un écho : les deux serpents du caducée pourraient être lus, par extension poétique, comme le souvenir de ce couple réconcilié jusque dans la métamorphose.",
  ...
  "foudre":{icon:"⚡",label:"Foudre",category:"Mythologie",desc:"Attribut de Zeus : autorité, révélation soudaine, jugement qui s'impose de lui-même.",links:["zeus"],lore:[
    ...
    "Zeus l'utilisa un jour malgré lui contre celle qu'il aimait : Sémélé, désireuse de voir son amant divin sous sa forme véritable, l'exigea de lui — et fut instantanément réduite en cendres par l'éclat de la foudre, que nul mortel ne peut contempler sans en mourir.",
  ...
  "grenade":{icon:"🔴",label:"Grenade",category:"Mythologie",desc:"Le fruit aux innombrables graines : fertilité, abondance, cycle, attachement, ce qui relie au monde souterrain — associée à Perséphone et Hadès.",links:["perséphone","hadès","ascalaphos"],lore:[
    ...
    "C'est Ascalaphos, gardien du jardin des Enfers, qui la vit cueillir ce fruit et le rapporta aux autres dieux — un témoignage qui scella son sort, et qui lui valut d'être changé en chouette une fois sa vengeance venue.",
  ...
  "miroir":{icon:"🪞",label:"Miroir",category:"Objets mythologiques",desc:"Introspection, vérité renvoyée, perception de soi parfois inconfortable.",links:["aphrodite"],lore:[
    ...
    "Le miroir rejoint aussi un tout autre mythe, plus sombre : Narcisse, épris de son propre reflet dans l'eau d'une source, ne put jamais s'en détacher et dépérit à force de le contempler sans fin — la preuve que la même surface qui révèle peut aussi retenir prisonnier celui qui s'y regarde trop longtemps.",
  ...
  "serpent":{icon:"🐍",label:"Serpent",category:"Animaux",desc:"Transformation, connaissance, guérison, lien avec le monde souterrain.",links:["hygie"],lore:[
    ...
    "Le serpent est aussi associé à Asclépios, dieu de la médecine. Son image enroulée autour du bâton du dieu est devenue un symbole de guérison — sa fille Hygie en tient elle aussi un, enroulé autour d'une coupe plutôt qu'un bâton : cette variante précise est restée le symbole international de la pharmacie.",
  ...
  "bélier":{icon:"🐏",label:"Bélier",category:"Animaux",desc:"Le bélier à la Toison d'or : sacrifice salvateur, guide céleste, quête à accomplir.",links:["hermès"],lore:[
    ...
    "C'est cette même Toison d'or que Jason ira chercher des générations plus tard à la tête des Argonautes, avec l'aide décisive de la magicienne Médée.",
  ...
  "scorpion":{icon:"🦂",label:"Scorpion",category:"Animaux",desc:"Envoyé par Apollon contre Orion : jalousie protectrice, mise à distance éternelle.",links:["apollon","artémis"],lore:[
    "Le scorpion apparaît dans le mythe d'Orion, le chasseur géant devenu le compagnon de chasse d'Artémis — une complicité si grande qu'Apollon, craignant de voir sa sœur s'éprendre d'un mortel, décide d'y mettre fin.",
  ...
  "pomme":{icon:"🍎",label:"Pomme",category:"Fruits & graines",desc:"Beauté, désir et rivalité — le fruit du jugement de Pâris.",links:["aphrodite","héraclès"],lore:[
    ...
    "Ces mêmes pommes d'or jouent aussi un rôle décisif dans la course d'Atalante : pour la ralentir, Hippomène en laisse tomber trois devant elle, empruntées au jardin des Hespérides, et c'est en s'arrêtant chaque fois pour les ramasser qu'elle finit par perdre la course — et gagner, du même geste, un mari à sa mesure.",
  ...
  "étoiles":{icon:"✦",label:"Étoile",category:"Astres & phénomènes",desc:"Orientation, espoir, inspiration retrouvée après l'épreuve.",links:["hécate","astéria","éos","cassiopée"],lore:[
    ...
    "Toutes les constellations ne sont pas des récompenses : la reine Cassiopée, punie pour s'être vantée d'une beauté supérieure à celle des Néréides, fut elle aussi placée parmi les étoiles, mais condamnée à y tourner la tête en bas une bonne partie de l'année.",
...
const DEITY_LORE = {
  "dionysos": [
    ...
    "Une réconciliation passagère avec Aphrodite, après qu'elle se fut un temps éprise d'Adonis, lui donna aussi un fils, Priape — un enfant que la jalousie d'Héra frappa dès sa naissance d'une laideur difforme (voir la fiche « Aphrodite »).",
  ...
  "hermès": [
    "Fils de Zeus et de Maïa, l'aînée des Pléiades, Hermès naquit dans une grotte du mont Cyllène (voir la fiche « Grotte ») et manifesta son astuce dès le jour de sa naissance : il déroba le troupeau de son frère Apollon, puis inventa la lyre à partir d'une carapace de tortue et la lui offrit en échange de son pardon (voir la fiche « Lyre »).",
  ...
  "héra": [
    ...
    "Elle ne se contente jamais d'observer : elle pousse Sémélé à sa perte par ruse, poursuit Héraclès de sa colère toute sa vie durant simplement parce qu'il est le fruit d'une liaison de Zeus (voir la fiche « Héraclès »), et impose à Léto l'interdiction de mettre au monde ses enfants sur la moindre terre ferme, retardant ainsi la naissance d'Apollon et d'Artémis.",
  ...
  "éros": [
    ...
    "Les récits plus tardifs en font le fils d'Aphrodite, armé d'un arc dont les flèches font naître l'amour chez quiconque elles atteignent, y compris les dieux eux-mêmes. Son propre amour pour la mortelle Psyché ne fut possible qu'au prix d'épreuves redoutables imposées par Aphrodite, jalouse de sa belle-fille.",
  ...
  "apollon": [
    ...
    "Chef de chœur des Muses, qu'il conduit sous le nom d'Apollon Musagète, « guide des Muses », il partage avec elles le mont Parnasse et sa source Castalie, non loin de son propre sanctuaire de Delphes.",
  ...
  "thémis": [
    ...
    "Unie à Zeus, elle mit au monde les Heures, gardiennes de l'ordre saisonnier et moral du monde, et, selon une tradition parallèle à celle qui les dit plutôt filles de la Nuit, les Parques elles-mêmes, qui filent le destin de chaque mortel.",
  ...
  "héraclès": [
    ...
    "Il obtint ensuite la ceinture d'Hippolyté, reine des Amazones, d'abord prête à la lui offrir de bon cœur — jusqu'à ce qu'Héra, semant la discorde parmi les Amazones, ne transforme la rencontre en bataille. Il ramena seul le troupeau de Géryon depuis les confins du monde connu, cueillit les pommes d'or des Hespérides en soulageant un temps Atlas de son fardeau céleste par la ruse — délivrant au passage Prométhée enchaîné, en abattant d'une flèche l'aigle qui lui dévorait le foie (voir la fiche « Prométhée ») —, et descendit enfin aux Enfers pour en ramener vivant, à mains nues, le chien Cerbère, avant de le rendre à Hadès.",
  ...
  "hadès": [
    ...
    "Avant elle, ou selon d'autres versions alors même qu'il en était déjà l'époux, Hadès s'était épris de la naïade Menthé, que Perséphone, découvrant cette liaison, changea de rage en la plante odorante qui porte encore son nom.",
  ...
  "perséphone": [
    ...
    "C'est Ascalaphos, gardien du jardin des Enfers, qui rapporta l'avoir vue manger ce fruit — un témoignage qu'elle ne lui pardonna jamais, et qui lui valut, une fois devenue reine, d'être changé en chouette.",
    "Un acte d'amour put pourtant fléchir cette rigueur : touchée par le sacrifice d'Alceste, morte de son plein gré à la place de son époux, elle la renvoya elle-même auprès des vivants — une clémence rare chez une reine par ailleurs si peu encline au pardon.",
  ...
  "iris": [
    ...
    "Ses propres sœurs, les Harpyes, lui durent un jour la vie sauve : poursuivies par les fils ailés de Borée (voir la fiche « Borée »), Zétès et Calaïs, décidés à les tuer pour libérer le devin Phinée de leurs tourments, elles ne durent leur salut qu'à l'intervention personnelle d'Iris, venue en plein vol obtenir des deux frères la promesse de les épargner.",
  ...
  "séléné": [
    ...
    "Éprise du berger Endymion, elle obtint de Zeus qu'il reste éternellement jeune et endormi, afin de pouvoir le contempler chaque nuit sans jamais le voir vieillir ni mourir.",
  ...
  "hélios": [
    ...
    "Sa petite-fille Médée, fille d'Aiétès, hérita elle aussi de ce sang — et de bien plus qu'un simple don pour les sortilèges : lorsqu'elle dut fuir Corinthe après s'être vengée de Jason, c'est un char ailé tiré par des dragons, prêté par Hélios lui-même, qui l'emporta hors d'atteinte.",
  ...
  "minos": [
    ...
    "Sur terre, il fit construire par Dédale le Labyrinthe pour y enfermer le Minotaure, fruit d'une union contre nature de son épouse Pasiphaé — un épisode qui n'entacha jamais, dans les Enfers, la légitimité de son jugement sur les autres âmes. C'est sa propre fille Ariane qui, en secret, permit à Thésée d'en ressortir vivant (voir la fiche « Ariane »).",
  ...
  "aphrodite": [
    ...
    "Deux liaisons plus brèves lui donnèrent chacune un enfant au destin singulier : unie à Hermès (voir la fiche « Hermès »), elle enfanta Hermaphrodite, promis à une tout autre métamorphose que la sienne ; unie à Dionysos (voir la fiche « Dionysos »), lors d'une réconciliation passagère après cette même passion pour Adonis, elle enfanta Priape, que la jalousie d'Héra frappa dès sa naissance d'une laideur difforme.",
  ...
  "éos": [
    ...
    "Elle aima aussi le chasseur Orion, qu'elle emporta à Délos pour vivre à ses côtés, avant qu'il ne devienne le compagnon de chasse d'Artémis.",
  ...
  "circé": [
    ...
    "Des années plus tard, cette même nièce vint jusqu'à son île implorer d'être purifiée du sang de son propre frère, versé en fuyant la Colchide avec Jason. Circé accepta le rite — mais seulement par égard pour le lien de sang qui l'unissait à Médée, jamais pour Jason lui-même, resté pour elle un étranger qu'elle ne chercha jamais à connaître davantage.",
  ...
  "ulysse": [
    ...
    "Dans le Tarot, Ulysse est la figure du 8 de Coupes, où un personnage s'éloigne de nuit, laissant des coupes soigneusement empilées derrière lui : après une année entière passée sur l'île de Circé (voir la fiche « Circé »), c'est bien lui qui choisit de reprendre la mer vers Ithaque, vers son épouse Pénélope, plutôt que de s'installer dans un confort déjà acquis.",
  ],
  "artémis": [
    ...
    "Farouchement attachée à sa virginité et à son intimité, elle règne sur les forêts sauvages (voir la fiche « Forêt ») et punit sans hésiter quiconque, comme Actéon, s'aventure à la surprendre.",
    "Elle fit pourtant une exception pour le chasseur Orion, devenu son compagnon de chasse le plus proche — jusqu'à ce que la jalousie de son frère mette fin à cette amitié.",
    "Sa colère peut se muer en pitié tout aussi soudainement : sur le point de laisser sacrifier Iphigénie à Aulis, elle la sauva au dernier instant en substituant une biche sur l'autel.",
    "La chasseresse Atalante, élevée à l'écart des hommes comme elle, partage avec elle ce même mode de vie farouche et indépendant.",
  ...
  "harmonie": [
    ...
    "Son mariage avec Cadmos, fondateur de Thèbes, fut célébré en présence de tous les dieux de l'Olympe, venus lui offrir des présents — dont un collier forgé par Héphaïstos et une robe de noces tissée par les Charites elles-mêmes, d'une beauté si rare qu'ils restèrent légendaires pour les générations suivantes.",
  ...
  "éris": [
    ...
    "Non invitée aux noces de Thétis et Pélée, par crainte qu'elle n'y sème le trouble, elle se présenta malgré tout et jeta parmi les déesses assemblées une pomme d'or portant une seule inscription : « à la plus belle ». Héra, Athéna et Aphrodite se la disputèrent aussitôt, jusqu'à ce que Zeus confie à Pâris le soin de trancher — un jugement qui déclenchera la guerre de Troie.",
  ...
  "némésis": [
    ...
    "C'est elle, selon la tradition la plus répandue, qui punit Narcisse pour avoir repoussé sans pitié tous ceux qui l'aimaient : elle le condamna à tomber amoureux de son propre reflet, un amour qu'il ne pourrait jamais obtenir en retour — la faute retournée contre celui qui l'avait commise.",
  ...
  "arès": [
    ...
    "Sa figure inspire aussi tout un peuple : les Amazones voient dans leur première reine, Otrera, une épouse mortelle d'Arès, qui aurait fondé en son honneur le sanctuaire d'Artémis à Éphèse — il devient ainsi, à travers elle, le père spirituel de la nation guerrière tout entière plutôt que le père littéral de chacune de ses reines, Antiope et Hippolyté parmi elles. Une seule d'entre elles porte pourtant, dans les textes anciens, le titre exact de « fille d'Arès » : Penthésilée, venue prêter main-forte à Troie après la mort d'Hector, tuée en duel par Achille qui, dit-on, pleura en découvrant la beauté de celle qu'il venait d'abattre.",
    "Une autre de ses filles, mortelle celle-là, marqua durablement Athènes : Alcippé, née d'une liaison avec la princesse Aglauros, fut agressée par Halirrhothios, fils de Poséidon, qu'Arès tua sur-le-champ pour la défendre — un geste qui lui valut son tout premier procès, jugé par les autres dieux eux-mêmes sur une colline d'Athènes qui garda depuis son nom.",
    "Chez Homère, il porte aussi le nom d'Enyalios, employé comme un simple équivalent du sien — Brotoloigos, « fléau des mortels », et Miaiphonos, « souillé de sang », en résument le tempérament plus brutalement encore. Une tradition plus tardive fit toutefois d'Enyalios une figure distincte, devenue le fils d'Arès et d'Enyo. À Tégée, en Arcadie, on l'honorait sous un nom plus surprenant, Gynaikothoinas, « celui que festoient les femmes » : les Tégéates, leur garnison masculine absente, auraient repoussé seuls un assaut spartiate mené en réalité par leurs propres femmes armées en secret — celles-ci célébrèrent leur victoire par un banquet dont les hommes furent exclus, un rite rendu depuis à Arès en souvenir du jour où la guerre échappa entièrement aux hommes.",
  ...
  "thalia": [
    "Thalia, dont le nom signifie « celle qui fleurit », est l'une des trois Charites — les déesses de la grâce et de la joie que la tradition ne représente jamais seules, toujours dansant ensemble.",
    ...
    "Une autre Thalie existe dans la mythologie grecque, l'une des neuf Muses, protectrice de la comédie et de la poésie pastorale : les deux Thalia restent distinctes, même si leur nom commun — et leur joie partagée — les rapproche.",
  ...
  "euphrosyne": [
    "Euphrosyne, dont le nom signifie « joie » ou « bonne humeur », est l'une des trois Charites — les déesses de la grâce que la tradition ne représente jamais seules, toujours dansant ensemble aux côtés d'Aglaé et de Thalia (voir les fiches « Aglaé » et « Thalia »).",
  ...
  "aglaé": [
    "Aglaé, dont le nom signifie « splendeur » ou « éclat », est la plus jeune des trois Charites — les déesses de la grâce que la tradition ne représente jamais seules, toujours dansant aux côtés d'Euphrosyne et de Thalia (voir les fiches « Euphrosyne » et « Thalia »).",
...
// Retour direct d'utilisatrice : au lieu du texte "" qui alourdissait
...
// "" profiteront donc automatiquement du même traitement, sans rien changer
// à la façon d'écrire.
...
// 4 premières par ordre alphabétique de Figures mythologiques — recalculé après la suppression
// des 157 fiches non incarnées par une carte du jeu (seules les 78 figures reliées à une carte
// restent dans DEITY_NOTES) : "abaris", "achille", "actéon" et "admète" n'ont eux-mêmes aucune
// carte et ont donc disparu avec les autres, au profit d'"aglaé", "agon", "aletheia" et "alké".
const FREE_FIGURES = new Set(["aglaé", "agon", "aletheia", "alké"]);
...
function profil(){
  ...
  <div class="grid" style="margin-top:20px">
    ...
    <div class="tile" data-screen-go="contact"><strong>✉️ Nous contacter</strong><span>Une question, un bug à signaler, une idée ?</span></div>
  </div>
