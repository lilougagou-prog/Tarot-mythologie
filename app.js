...
const DEITY_LORE = {
  ...
  "arès": [
    ...
    "Sa figure inspire aussi tout un peuple : les Amazones voient dans leur première reine, Otrera (voir la fiche « Otrera »), une épouse mortelle d'Arès, qui aurait fondé en son honneur le sanctuaire d'Artémis à Éphèse — il devient ainsi, à travers elle, le père spirituel de la nation guerrière tout entière plutôt que le père littéral de chacune de ses reines, Antiope et Hippolyté parmi elles (voir les fiches « Antiope » et « Hippolyté »). Une seule d'entre elles porte pourtant, dans les textes anciens, le titre exact de « fille d'Arès » : Penthésilée, venue prêter main-forte à Troie après la mort d'Hector, tuée en duel par Achille qui, dit-on, pleura en découvrant la beauté de celle qu'il venait d'abattre.",
