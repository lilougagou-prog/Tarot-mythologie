...
Les portraits sont toujours recadrés uniquement au ratio 3/4 des cartes (mémo, galerie, fiche), jamais recoupés pour cacher un objet tenu par le personnage : même si l'attribut est parfois visible sur le portrait (ex. Hécate et ses torches), on garde l'illustration complète plutôt qu'un cadrage serré artificiel.
